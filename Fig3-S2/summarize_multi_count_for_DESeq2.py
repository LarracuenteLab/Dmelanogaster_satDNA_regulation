...
# -*- coding: utf-8 -*-
"""
This script generate input files for DESeq2.
@author: Xiaolu Wei (xiaolu_wei@urmc.rochester.edu)
"""

from argparse import ArgumentParser

p=ArgumentParser(description="This script summarize .out files from count_proportional output from different genotypes together, all features, for DESeq2 input.")
