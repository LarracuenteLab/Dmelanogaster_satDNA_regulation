...
"""
This script run DESeq2 with read count files for Supllementary file 9 (total RNA).
...
python3 /scratch/alarracu_lab/Xiaolu/pipelines/htseq-count/summarize_multi_count_for_DESeq2.py -n "$name" -s "$study" -c "SRR8578627.${suffix}" -t "SRR8578628.${suffix}" -o "$name" 
